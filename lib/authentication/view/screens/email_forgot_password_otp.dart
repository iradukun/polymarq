...
class EmailForgotPasswordOtpScreen extends StatelessWidget {
  EmailForgotPasswordOtpScreen({super.key});
                  ...
                  CustomButton(
                    ...
                    onTap: () async {
                      if (formKey.currentState?.validate() ?? false) {
                        final response =
                            await authViewModel.verifyForgotPasswordOTP();
                        if (response.isSuccessful && context.mounted) {
                          unawaited(Navigator.pushNamed(
                              context, AppRoute.newPasswordPage,),);
