...
class PhoneNoNewPasswordScreen extends StatefulWidget {
  const PhoneNoNewPasswordScreen({super.key});

  @override
  State<PhoneNoNewPasswordScreen> createState() => _PhoneNoNewPasswordScreenState();
}

class _PhoneNoNewPasswordScreenState extends State<PhoneNoNewPasswordScreen> {
