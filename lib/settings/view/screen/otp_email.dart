...
class OTPEmail extends ConsumerWidget {
  OTPEmail({required this.email, super.key});
  final String email;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen(settingViewModelProvider, (prev, next) {
      ...
      if (next is VerifyPasswordSuccess) {
        CustomAlert.show(context, message: 'Email verified successfully', success: true);
                ...
                onTap: () async {
                  if (formKey.currentState?.validate() ?? false) {
                    await ref
                        ...
                        .verifyPasswordWithEmail(otp: _otpController.text);
                  }
                },
              ),
