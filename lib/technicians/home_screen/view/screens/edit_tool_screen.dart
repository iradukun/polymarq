...
class EditToolScreen extends ConsumerStatefulWidget {
  const EditToolScreen({required this.model, super.key});
  final Prefix.AllToolsModel model;
...
class _EditToolScreenState extends ConsumerState<EditToolScreen> {
  ...
  void initState() {
    ...
    //textEditingController.text = widget.model.category?.name ?? '';
    ...
    ref.listen(homeNotifier, (prev, next) {
      ...
      if (next is EditToolSuccess) {
        ...
        Future.delayed(const Duration(seconds: 1), () {
          Navigator.pushNamed(context, AppRoute.productCategoriesPage);

          ref.invalidate(getMyToolProvider(widget.model.uuid ?? ''));
        });
      }
    });
    return Scaffold(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              ...
                              children: widget.model.colorCodes!
                                  .map(
                                    (e) => GestureDetector(
                                      onTap: () {
                                        setState(() {
                          ...
                          CustomTextFieild(
                            ...
                            //  textName: widget.model.description ?? '',
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              // ),
                              const Text(
                                'Upload Some Images of The Tool',
                                style: TextStyle(
                                  fontSize: 12,
                                  color: AppColor.black,
                                  fontWeight: FontWeight.w500,
                                ...
                                itemBuilder: (context, index) => Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      width: 330,
                                      imageUrl:
                                          widget.model.images?[index].image ??
                                              '',
                          ...
                          CustomButton(
                            ...
                            onTap: () async {
                              await ref.read(homeNotifier.notifier).editTools(
                                    ...
                                    toolColor: widget.model.colorCodes,
                                    isRented: widget.model.isRented!,
