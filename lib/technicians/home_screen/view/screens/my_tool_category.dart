...
class MyToolCategoryScreen extends ConsumerStatefulWidget {
  const MyToolCategoryScreen({super.key});

  @override
  ConsumerState<MyToolCategoryScreen> createState() =>
      _MyToolCategoryScreenState();
}

class _MyToolCategoryScreenState extends ConsumerState<MyToolCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    final getCategory = ref.watch(getCategoryProvider(_query.text));
    return Scaffold(
      appBar: AppBar(
