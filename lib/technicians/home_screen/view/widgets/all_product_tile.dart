...
class AllProductTile extends ConsumerStatefulWidget {
  const AllProductTile({
  ...
  @override
  ConsumerState<AllProductTile> createState() => _AllProductTileState();
}

class _AllProductTileState extends ConsumerState<AllProductTile> {
  @override
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        fit: BoxFit.cover,
                        width: double.infinity,
                        imageUrl: widget.allToolsModel.images!.isEmpty
                  ...
                  onSelected: (value) {
                    if (value == 1) {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  EditToolScreen(model: widget.allToolsModel),),);
                    } else {
                  ...
                  child: CustomButton(
                    ...
                    onTap: () {
                      ref
                          ...
                          .deleteTools(uuid: widget.allToolsModel.uuid ?? '')
                          .then((value) {
                        CustomAlert.show(
                          context,
